...
def handle_game_over():
    ...
    if game_over_timer > 0:
        ...
        screen.blit(last_wave_text_line1, (SCREEN_WIDTH // 2 - last_wave_text_line1.get_width() // 2, SCREEN_HEIGHT // 2 + 100))

        last_wave_text_line2 = font.render("Press Enter to Restart", True, WHITE)
        screen.blit(last_wave_text_line2, (SCREEN_WIDTH // 2 - last_wave_text_line2.get_width() // 2, SCREEN_HEIGHT // 2 + 200))
